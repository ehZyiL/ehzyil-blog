...
import static com.ehzyil.constant.RedisConstant.USER_TALK_LIKE;
...
public class TalkLikeStrategyImpl implements LikeStrategy {
    ...
    public void like(Integer talkId) {
        Talk talk = talkMapper.selectOne(new LambdaQueryWrapper<Talk>().select(Talk::getId).eq(Talk::getId, talkId));
